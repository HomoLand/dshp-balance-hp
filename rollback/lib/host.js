...
markRemote(BalanceGateway.prototype, 'getState', 'get-state')
markRemote(BalanceGateway.prototype, 'refresh', 'refresh')
markRemote(BalanceGateway.prototype, 'setTodayBase', 'set-today-base')
markRemote(BalanceGateway.prototype, 'clearTodayBase', 'clear-today-base')
markRemote(BalanceGateway.prototype, 'setConfig', 'set-config')
