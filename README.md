...
| 三国杀 | 太极半形勾玉（鱼眼在头），数量 3/4/5/6/8/10 可调，低血量 2 玉橙 / 1 玉红 |

### 勾玉调试 · 旋转角度

三国杀皮肤下，设置界面提供旋转角调试（-180°~+180°，**顺时针为正**，默认 **-10°**）：
滑块/数字输入/±5°/重置，实时旋转勾玉与高光路径，角度持久化。
...
- `src/client.js` — 客户端半区（5 种皮肤、勾玉 SVG 路径、设置界面、旋转调试）
